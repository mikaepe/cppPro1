...
/* main function: Computes ASI for the function f between a=-1 and 
 * b=1 with tolerance tol, outputs the computed value and the 
 * corresponding value computed with matlab
 */
